...
variable "enable_backend" {
  description = "Whether to configure ALB as a backend origin and API path behaviors"
  type        = bool
  default     = true
}
...
variable "enable_api_gateway" {
  description = "Whether to configure API Gateway as an origin for API paths"
  type        = bool
  default     = false
}
